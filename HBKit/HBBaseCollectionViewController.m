...
- (UICollectionReusableView *)collectionView:(UICollectionView *)collectionView viewForSupplementaryElementOfKind:(NSString *)kind atIndexPath:(NSIndexPath *)indexPath
{
    if (kind == UICollectionElementKindSectionHeader) {
        ...
        cell_struct *cell_struce = [self.dataDictionary cell_cellstructobjectForKey:KEY_INDEXPATH(indexPath.section, 0)];
        ...
        view.titleLabel.textColor = [cell_struct_common cell_colorWithStructKey:cell_struce.sectioncolor];
