...
{\
    if (!_cell_struct_cell0) {\
        _cell_struct_cell0 = [HBCellStruct new];
        _cell_struct_cell0.cellheight = 45;
        _cell_struct_cell0.title = @"0";
        _cell_struct_cell0.sel_selector = @selector(selectAction:);
        // [HBCellStruct cell_x_x_struct:@" 0" detailvalue:nil target:self selectAction:@selector(selectAction:)];
    }
